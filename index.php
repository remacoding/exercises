...
<html lang="en">
  <head>
    ...
    <a href="#"
      ><i class="ion-social-facebook" data-icon="ion-social-facebook"></i
    ></a>
    ...
    <a href="#"
      ><i class="icon iconify" data-icon="ion-social-instagram"></i
    ></a>
  </head>
  <body id="page-top">
    <nav
      ...
      <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto my-2 my-lg-0" style="color: #fff">
            ...
            <li class="nav-item">
              <a class="nav-link" style="color: #fff" href="#portfolio"
                >Trophies</a
              >
            </li>
            <li class="nav-item">
      ...
      <div class="container-fluid p-3">
        <div class="row g-0">
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/7.jpeg"
              title="The best club of the 20th century Fifa trophy"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/7.jpeg"
                alt="..."
              />
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/8.jpeg"
              title="18 Regional Championship"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/8.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/1.jpeg"
              title="2 Uefa Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/1.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/10.jpeg"
              title="5 European Super Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/10.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/2.jpeg"
              title="14 European Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/2.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/3.jpeg"
              title="5 Mancomunados Trophies"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/3.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">5</div>
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/4.jpeg"
              title="35 National Leagues"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/4.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/5.jpeg"
              title="19 Spanish Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/5.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/6.jpeg"
              title="12 Spanish Super Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/thumbnails/6.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/11.jpeg"
              title="7 Fifa Club World Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/11.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
          ...
          <div class="col-lg-4 col-sm-6 p-2">
            <a
              class="portfolio-box"
              href="assets/img/trophies/fullsize/12.jpeg"
              title="2 Small World Cups"
            >
              <img
                class="img-fluid"
                src="assets/img/trophies/fullsize/12.jpeg"
                alt="..."
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">2</div>
...
<!-- Contact us ends -->
    ...
    <div class="container-fluid pb-0 mb-0 justify-content-center text-light ">
          ...
          <div class="row my-5 justify-content-center py-5">
              <div class="col-11">
                <div class="row">
                  <div class="col-xl-8 col-md-4 col-sm-4 col-12   my-auto mx-auto a"><h3 class="text-muted mb-md-0 mb-5 bold-text">RealMadrid Trophies.</h3></div>
                  <div class="col-xl-2 col-md-4 col-sm-4 col-12"><h6 class="mb-3 mb-lg-4 bold-text "><b>MENU</b></h6><ul class="list-unstyled"><li><li>Home</li><li>About</li><li>Blog</li><li>Portfolio</li></ul></div>
                  <div class="col-xl-2 col-md-4 col-sm-4 col-12"><h6 class="mb-3 mb-lg-4 text-muted bold-text mt-sm-0 mt-5"><b>ADDRESS</b></h6><p class="mb-1">RAUHANKATU 22</p><p>00880 HELSINKI</p> </div>
              </div>
                  <div class="row">
                      <div class="col-xl-8 col-md-4 col-sm-4 col-auto  my-md-0 mt-5 order-sm-1 order-3 align-self-end"><p class="social text-muted mb-0 pb-0 bold-text"> <span  class="mx-2"><i class="fa fa-facebook" aria-hidden="true"></i></span> <span class="mx-2"><i class="fa fa-linkedin-square" aria-hidden="true"></i></span> <span class="mx-2"><i class="fa fa-twitter" aria-hidden="true"></i></span> <span class="mx-2"><i class="fa fa-instagram" aria-hidden="true"></i></span> </p><small class="rights"><span>&#174;</span> RealMadrid Trophies All Rights Reserved.</small></div>
                      <div class="col-xl-2 col-md-4 col-sm-4 col-auto order-1 align-self-end "><h6 class="mt-55 mt-2 text-muted bold-text"><b>Email</b></h6><small> <span><i class="fa fa-envelope" aria-hidden="true"></i></span> support@gmail.com</small></div>
                      <div class="col-xl-2 col-md-4 col-sm-4 col-auto order-2 align-self-end mt-3   "><h6 class="text-muted bold-text"><b>Phone</b></h6><small><span><i class="fa fa-envelope" aria-hidden="true"></i></span> +358 40 765 9927</small></div>
                  </div>
              </div>
          </div>
      <section>
...
// read data from the "contact" table
